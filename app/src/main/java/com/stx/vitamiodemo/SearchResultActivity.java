...
public class SearchResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String query = intent.getStringExtra("extra_data");
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        ProgressDialog pdLoading = new ProgressDialog(SearchResultActivity.this);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("http://218.75.127.36:18080/test/fish-search.php");
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equals("no rows")) {
                ...
                try {
                    ...
                    mAdapter = new AdapterFish(SearchResultActivity.this, data);
                    mRVFish.setAdapter(mAdapter);
                    mRVFish.setLayoutManager(new LinearLayoutManager(SearchResultActivity.this));
